...
# what learned 
learned about git init - used to create repo from local syatem.
git remote add origin (link) - used to link local and github .
git remote -v = to verify the remote is link or not.
